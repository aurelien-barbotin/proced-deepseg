...
files = ['/home/aurelienb/Documents/Projects/collaborations/MerveNur/SIM/Co-culture_Active_MCR-1_1red.tif']
print(files)

from omnipose.utils import normalize99
imgs = [io.imread(f)**2 for f in files]
imgs=[w[:4] for w in imgs]
